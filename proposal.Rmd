...
2. Predictive Modeling with regression model,SVM,  k-Nearest-Neighbor,  random forest, xgboost method on train data.

3. evaluate model performances on test data.

4. extract patterns from data and analyse Ad fraud behaviour.
